...
# Select a particular sheet (create or get by name)
report_sheet = 'Report'
datasource_sheet = 'DataSource'
sheet1 = wb[report_sheet] if report_sheet in wb.sheetnames else wb.create_sheet(
    title=report_sheet)
sheet1.append(['Report Name', 'Report ID'])
sheet2 = wb[datasource_sheet] if datasource_sheet in wb.sheetnames else wb.create_sheet(
    title=datasource_sheet)
sheet2.append(
...
class CognosApiClient:
            ...
            if response.status_code == 200:
                ...
                for d in content_response['content']:
                    if(d['type']=='folder'):
                        ...
                        self.sheet1.append([d['defaultName'], d['id']])
                ...
                while(True):
                    ...
                    for d in item_response['content']:
                        ...
                        if(d['type']=='folder'):
                            ...
                            self.report_names.append(d['defaultName'])
                            report_val.append([d['defaultName'], d['id']])
                            sheet1.append([d['defaultName'], d['id']])
                            self.report_count = self.report_count + 1
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for d in datasources_reponse['dataSources']:
                    ...
                    self.get_connections(d['id'], d['defaultName'])
    ...
    def get_connections(self, datasource_id, datasource_name):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for c in connection_response['connections']:
                    ...
                    lis.append([c['id'], c['defaultName'], c['connectionString']])
                ...
                for conn in lis:
                    # print("val", conn)
                    self.get_signons(datasource_id, datasource_name, conn[0], conn[1], conn[2])

            else:
                sheet2.append([datasource_id, datasource_name, '', '', '', '', '', '', '', ''])
    ...
    def get_signons(self, datasource_id, datasource_name, connection_id, connection_name, connection_string):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if len(signon_response['signons'])==0:
                    sheet2.append([datasource_id, datasource_name, connection_id, connection_name, connection_string, '', '', '', '', ''])
                    print("\nNo Signon Present.")
                ...
                for signon in lis:
                     ...
                     self.get_schemas(datasource_id, datasource_name, connection_id, connection_name, connection_string, signon[0], signon[1])
                     self.get_tables(datasource_id, datasource_name, connection_id, connection_name, connection_string, signon[0], signon[1])
    ...
    def get_schemas(self, datasource_id, datasource_name, connection_id, connection_name, connection_string, signon_id, signon_name):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for sch in schemas_response['schemas']:
                    ...
                    sheet2.append([datasource_id, datasource_name, connection_id, connection_name, connection_string, signon_id, signon_name, sch['id'], sch['defaultName'], sch['catalog']])
                ...
                sheet2.append([datasource_id, datasource_name, connection_id, connection_name, connection_string, signon_id, signon_name, '', '',''])
    ...
    def get_tables(self, datasource_id, datasource_name, connection_id, connection_name, connection_string, signon_id, signon_name):
